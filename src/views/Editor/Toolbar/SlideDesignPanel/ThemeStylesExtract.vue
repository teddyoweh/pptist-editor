<template>
  <div class="theme-styles-extract">
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()"><i-icon-park-outline:check /> Save Selected Configuration as Theme</Button>
    </div>
  </div>
</template>
...
const updateAllThemes = () => {
  ...
  if (themeColors.length > 6) {
    ...
    message.warning('Theme colors exceeded limit, automatically selected first 6')
  }
