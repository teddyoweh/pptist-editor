<template>
  <div class="slide-design-panel">
    ...
    <div class="background-gradient-wrapper" v-if="background.type === 'gradient'">
      ...
      <div class="row">
        <div style="width: 40%;">Current Stop:</div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyBackgroundAllSlide()"><i-icon-park-outline:check /> Apply to All Slides</Button>
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyFontToAllSlides(theme.fontName)"><i-icon-park-outline:check /> Apply Font to All</Button>
    </div>
