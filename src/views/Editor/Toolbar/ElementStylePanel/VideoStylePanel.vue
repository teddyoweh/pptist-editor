<template>
  <div class="video-style-panel">
    <div class="title">Video Preview Thumbnail</div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="setVideoPosterFromFirstFrame()"><i-icon-park-outline:screenshot-one /> Set First Frame as Thumbnail</Button>
    </div>
    <div class="row" v-if="handleVideoElement.poster">
      <Button style="flex: 1;" @click="updateVideo({ poster: '' })"><i-icon-park-outline:undo /> Reset Thumbnail</Button>
    </div>
...
// Get video first frame as preview thumbnail
