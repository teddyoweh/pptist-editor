<template>
  <div class="element-animation-panel">
    ...
    <div class="tip" v-else><i-icon-park-outline:click style="margin-right: 5px;" /> Select an element on canvas to add animation</div>
...
// Animation list for current slide
...
// Entrance animation info for currently selected element
...
// Sync data after drag-and-drop reordering of animations
...
// Update element animation and run preview once
...
// Add element animation and run preview once
...
// Remove mask 600ms after animation panel opens, otherwise quick mouse hover after opening causes jitter
