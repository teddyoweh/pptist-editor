...
export default (canvasRef: ShallowRef<HTMLElement | null>) => {
  ...
  // Initialize viewport position on canvas
  ...
  // Update viewport position on canvas
  ...
  // Reset/update viewport position when zoom or ratio changes
  ...
  // Reset viewport position when canvas drag state changes (restored)
  watch(canvasDragged, () => {
