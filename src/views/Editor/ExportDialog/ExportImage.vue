    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'Web fonts are ignored by default during export. If you use web fonts in your slides and want to preserve their styling, you can disable this option. Note that this will increase export time.'" />
        </div>
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expImage()"><i-icon-park-outline:download /> Export Images</Button>
