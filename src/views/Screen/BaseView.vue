  ...
  <div class="base-view" :class="{ 'laser-pen': laserPen }">
    ...
    >
      <div class="content">
        ...
        <i-icon-park-outline:write class="tool-btn" v-tooltip="'Drawing Tools'" @click="writingBoardToolVisible = true" />
        ...
        <i-icon-park-outline:power class="tool-btn" v-tooltip="'End Presentation'" @click="exitScreening()" />
      </div>
    </div>
...
const contextmenus = (): ContextmenuItem[] => {
  return [
    ...
    { divider: true },
    {
      text: autoPlayTimer.value ? 'Stop Auto Play' : 'Auto Play',
