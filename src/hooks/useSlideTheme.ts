...
export default () => {
  ...
  // Get the main theme styles within the specified slide(s), sorted by their proportional area
  ...
  // Get the main colors within the specified slide (ignoring transparency), sorted by color area
  ...
  // Apply uniform font to all slides
