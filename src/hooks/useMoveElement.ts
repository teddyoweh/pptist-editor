...
export default () => {
  ...
  /**
   * Move element in specified direction by specified distance
   * When a group member element is selected for independent operation, move that element first. Otherwise move all selected elements by default
