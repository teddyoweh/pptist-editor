...
export default () => {
   ...
   * @param command Scale command: zoom in or zoom out
   */
  ...
  /**
   * Set canvas scale ratio
   * Instead of setting the value directly, it dynamically calculates by setting the canvas viewport percentage
   * @param value Target canvas scale ratio
   */
